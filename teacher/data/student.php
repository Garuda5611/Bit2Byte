...
function getAllSectionStudent($conn,$section_id){
  $sql = "SELECT * FROM students where section_id=? order by roll_no";
  $stmt = $conn->prepare($sql);
...
function sunameIsUnique($uname, $conn, $student_id=0){
